...
namespace WZIMopoly.GUI
{
    ...
    /// </summary>
    internal class GUIConsole : GUITexture
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GUIConsole"/> class.
        /// </summary>
        /// <param name="model">
        /// The model of the button.
        /// </param>
        ...
        /// </param>
        internal GUIConsole(ConsoleModel model) : base(model.DefDstRect)
        {
            _model = model;
        }
