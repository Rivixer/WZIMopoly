...
namespace WZIMopoly.GUI.LobbyScene
{
    ...
    internal class GUILobbyCode : GUIElement
    {
        ...
        {
            _model = model;
            _background = new GUITexture("Images/LobbyCode", new Rectangle(960, 760, 321, 74), GUIStartPoint.Center);
            _text = new GUIText("Fonts/WZIMFont", new Vector2(960, 760), Color.Black, GUIStartPoint.Center, scale: 0.45f);
            _infoText = new GUIText("Fonts/WZIMFont", new Vector2(960, 700), Color.Black, GUIStartPoint.Center, scale: 0.35f);
        }
